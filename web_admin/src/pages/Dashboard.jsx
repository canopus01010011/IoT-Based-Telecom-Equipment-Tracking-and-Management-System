...
export default function Dashboard() {
  ...
  return (
    <PageLayout title={t.overview}>
      ...
      >
        {missions.map(m => (
          <div key={m.id} style={{ display:'grid', gridTemplateColumns: COLS, padding:'12px 20px', fontSize:12, color:'#cbd5e1', borderBottom:'0.5px solid rgba(255,255,255,.04)', alignItems:'center' }}>
